...
function stickyMenu(){
  ...
  $(".header-inner").toggleClass("fix-header", s0w991);
...
$(document).ready(function() {	
	...
	// move category name
	$('header').after('<div class="title-category"><div class="container"><div class="container-inner"></div></div></div>');
	var category_name = $('h2.category-name');
	category_name.appendTo('.title-category .container-inner');
	
	// move breadcrumbs
	//$('header').after('<div class="breadcrumbs"><div class="container"></div></div>');	
	var breadcrumb = $('ul.breadcrumb');
	//var breadcrumbs_container = $('.breadcrumbs .container');
	breadcrumb.appendTo('.title-category .container-inner');
