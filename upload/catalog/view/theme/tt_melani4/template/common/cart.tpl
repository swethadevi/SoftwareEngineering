<div id="cart" class="btn-group btn-block">
  <button type="button" data-toggle="dropdown" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-inverse btn-block btn-lg dropdown-toggle"><i class="icon ion-bag"></i> <span id="cart-total"><?php echo $text_items2; ?></span></button>
        ...
        <tr>
          ...
          <td class="text-left info-item">
			  <a class="cart-name" href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a>
				...
				<?php } ?>
				<p class="cart-quantity"><?php echo $product['quantity'].' x '; ?></p>
