...
<?php
	...
	if(!$row) {$row=1;}
?>
<div class="product-tabs-category-container-slider special-button-owl <?php echo $cateogry_alias;?> quickview-add module-nav2 module-style1">
