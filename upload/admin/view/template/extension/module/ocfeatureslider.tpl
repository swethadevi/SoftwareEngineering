          ...
          <div class="form-group required">
			...
			<div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <div class="input-group">
                        <span class="input-group-addon"><?php echo $language['name']; ?></span>
                        <input type="text" name="sub_title[<?php echo $language['code']; ?>][sub_title]" value="<?php echo isset($sub_title[$language['code']]['sub_title']) ? $sub_title[$language['code']]['sub_title'] : ''; ?>" placeholder="" id="input-sub-title<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
                    <?php } ?>
                </div>
            </div>
